...
/// {@tool snippet}
///
/// This widget introduces a [MaterialApp], [Scaffold] and [PreloadPageView] with two pages
/// using the default constructor. Both pages contain an [ElevatedButton] allowing you
/// to animate the [PreloadPageView] using a [PreloadPageController].
///
/// ```dart
...
///
/// {@tool dartpad}
/// Here is an example of [PreloadPageView]. It creates a centered [Text] in each of the three pages
...
class PreloadPageView extends StatefulWidget {
  ...
  /// [PreloadPageView] will participate in accessibility scrolling more like a
  /// [ListView], where implicit scroll actions will move to the next page
  /// rather than into the contents of the [PreloadPageView].
  /// {@endtemplate}
  PreloadPageView({
    super.key,
  ...
  /// {@tool snippet}
  ///
  /// This [PreloadPageView] uses a custom [SliverChildBuilderDelegate] to support child
  /// reordering.
  ///
  /// ```dart
  /// class MyPageView extends StatefulWidget {
          ...
          return Viewport(
            ...
            cacheExtent: widget.allowImplicitScrolling
                ? (widget.preloadPagesCount < 1
                    ? 0
                    : widget.preloadPagesCount.toDouble())
                : 0,
